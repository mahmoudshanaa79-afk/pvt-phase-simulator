...
```
 ...
 src/pvt_phase_simulator_ui/views.py             | 348 +++++++++++++++++++-----
 tests/test_app_adapters.py                      | 151 +++++++++-
 tests/test_app_streamlit.py                     |  44 +++
 tests/test_app_sweeps.py                        |  84 +++++-
 14 files changed, 1131 insertions(+), 232 deletions(-)
...
+      "summary": "_presentation_figure's hovertemplate unit-label substitution uses a literal '.replace(\" K\", ...).replace(\" Pa\", ...)' string rewrite rather than a structured template; currently safe for all existing hover strings but fragile against future wording changes in the frozen plotting module."
+    },
+    {
+      "id": "D-2",
+      "summary": "Sweep-table pressure display rounds to a fixed 5 decimal digits regardless of the selected unit's magnitude (fine for Pa, imprecise-looking for psi/bar); cosmetic only."
     }
   ],
...
+  "builder_report_path": "C:\\Users\\user\\OneDrive - American University of Beirut\\Desktop\\pvt-phase-simulator\\.ai\\codex_reports\\20260906-210313-02_field_units-codex-report.md",
   "builder_evidence": {
     "builder": "codex",
...
+    "report_path": "C:\\Users\\user\\OneDrive - American University of Beirut\\Desktop\\pvt-phase-simulator\\.ai\\codex_reports\\20260906-210313-02_field_units-codex-report.md",
+    "report_sha256": "0f7b2fec506e8bbccf62b2ab580d0145540f7693c7eafe32d7c1a0229b6fa588",
     "revision": 1,
     "kind": "build"
   },
-  "tree_fingerprint": "26f7c0227453f1f2851c35ee7897ac909e05b24fb1876f0b9e11f4226cc01a00",
+  "tree_fingerprint": "e485c18ead6f410786d4a2262d1b126899dbadee6f76d1e7e582f5bb00d3ede7",
   "revisions": [
     {
-      "package": "01_model_and_limitations",
+      "package": "02_field_units",
...
@@ -25,7 +26,6 @@ from pvt_phase_simulator.eos.phase_envelope import (
 )
...
@@ -38,9 +38,11 @@ from pvt_phase_simulator.plotting import (
...
-    PA_PER_MPA,
     ...
     adapt_flash_result,
@@ -50,7 +52,7 @@ from pvt_phase_simulator_ui.adapters import (
     status_text,
...
@@ -71,9 +73,106 @@ from pvt_phase_simulator_ui.sweeps import (
     run_sweep,
...
+        if x_quantity is not None and g
… [truncated, 37314 more characters]
```
