...
+      "summary": "_presentation_figure's hovertemplate unit-label substitution uses a literal string .replace(\" K\", ...).replace(\" Pa\", ...) rather than a structured template; currently safe for all existing hover strings but fragile against future wording changes in the frozen plotting module."
+    },
+    {
+      "id": "D-2",
...
+  "claude_cost_usd_this_package": 3.7094054000000005,
...
+  "builder_report_path": "C:\\Users\\user\\OneDrive - American University of Beirut\\Desktop\\pvt-phase-simulator\\.ai\\codex_reports\\20260907-221445-02_field_units-codex-report.md",
   "builder_evidence": {
     "builder": "codex",
...
+    "report_path": "C:\\Users\\user\\OneDrive - American University of Beirut\\Desktop\\pvt-phase-simulator\\.ai\\codex_reports\\20260907-221445-02_field_units-codex-report.md",
+    "report_sha256": "1a513f5e7c824be54565c54185f323117f54c21a62d700b3e3b2b8bb439795ac",
     "revision": 1,
     "kind": "build"
   },
-  "tree_fingerprint": "26f7c0227453f1f2851c35ee7897ac909e05b24fb1876f0b9e11f4226cc01a00",
+  "tree_fingerprint": "de87e6b689473d3af6535dd4260c3d7df8fd617f54c3e334520fb3406aca3e46",
   "revisions": [
     {
-      "package": "01_model_and_limitations",
+      "package": "02_field_units",
...
@@ -30,7 +44,7 @@ INPUT_EXAMPLES: Final = (
         ethane_pct=0.0,
         propane_pct=50.0,
         temperature_k=300.0,
-        pressure_mpa=5.0,
...
@@ -38,7 +52,7 @@ INPUT_EXAMPLES: Final = (
         ethane_pct=0.0,
         propane_pct=50.0,
         temperature_k=300.0,
-        pressure_mpa=20.0,
...
@@ -46,7 +60,7 @@ INPUT_EXAMPLES: Final = (
         ethane_pct=0.0,
         propane_pct=50.0,
...
@@ -65,6 +79,54 @@ def initialize_session(state: MutableMapping[str, Any]) -> None:
...
@@ -79,6 +141,19 @@ def apply_selected_input_example(state: MutableMapping[str, Any]) -> None:
...
diff --git a/src/pvt_phase_simulator_ui/views.
… [truncated, 44021 more characters]
```
