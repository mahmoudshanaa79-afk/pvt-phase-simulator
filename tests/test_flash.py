...
INDEPENDENT_BETA = 0.8743634823367706
INDEPENDENT_LIQUID_COMPOSITION = (0.024719060931567425, 0.9752809390684325)
INDEPENDENT_VAPOR_COMPOSITION = (0.5682926989776415, 0.43170730102235855)
INDEPENDENT_LIQUID_ROOT = 0.0034634322203376234
INDEPENDENT_VAPOR_ROOT = 0.9794979385817287
INDEPENDENT_LIQUID_FUGACITIES_PA = (56273.07027526663, 41720.035635190216)
INDEPENDENT_VAPOR_FUGACITIES_PA = (56273.0702752667, 41720.03563519003)
...
def test_unstable_reference_enters_and_converges_flash(
    ...
    assert unstable_flash.initial_k_values == pytest.approx(
        (23.83372871631937, 0.4420204310520413),
        rel=2e-14,
    )
...
ADDITIONAL_UNSTABLE_REFERENCES = (
    (
        ...
        2_000_000.0,
        0.2502679396659671,
        (0.37070388802730103, 0.6292961119726989),
        (0.8873346324417498, 0.11266536755825016),
        0.061285537775865685,
        0.8067417039250433,
    ),
    (
        (METHANE, PROPANE),
        ...
        3_000_000.0,
        0.5445785543312142,
        (0.24772870565790409, 0.7522712943420958),
        (0.8945982739513398, 0.10540172604866015),
        0.09984006490345611,
        0.834899352290992,
    ),
    (
        ...
        2_000_000.0,
        0.6356121909531932,
        (0.23259408753819538, 0.5190117439425568, 0.24839416851924775),
        (0.8106288038182998, 0.1744435511674674, 0.014927645014232771),
        0.06323354315359164,
        0.8340248291725256,
    ),
)
